...
class WnD_model(nn.Module):
    ...
    def __init__(self, n_users, n_items, embed_size, features, dropout_rate = 0.3):
...
if __name__ == "__main__":
    ...
    f = open("test_record_WnD_" + domain + "_baseline_filtered.txt", "w")
    ...
    for run_count in range(5):
        ...
        TransE_feature_embeddings = nn.Embedding(n_items, 324).cuda()
